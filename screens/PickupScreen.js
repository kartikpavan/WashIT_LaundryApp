    ...
    <>
      <ScrollView>
        <SafeAreaView>
          {/* ADDRESS */}
          <View>
            <Text style={{ fontSize: 16, fontWeight: "500", padding: 10 }}>Enter Address</Text>
            ...
            {exactTime.map((item) => {
              return (
                ...
                >
                  <Text
                    style={
                      selectedTime.includes(item.time) ? { color: "white" } : { color: "black" }
                    }
                  >
                    {item.time}
                  </Text>
          ...
          {/* Delivery Date */}
          <View>
            <Text style={{ fontSize: 16, fontWeight: "500", padding: 10 }}>Delivery date</Text>
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
      ...
      {total_cart_price === 0 ? null : (
        <Pressable style={styles.container}>
          ...
          <Pressable style={styles.proceedFurtherBtn} onPress={proceedToCart}>
            <Text style={{ fontSize: 17, fontWeight: 500, color: "teal" }}>Proceed to Cart</Text>
          </Pressable>
        </Pressable>
      )}
    </>
